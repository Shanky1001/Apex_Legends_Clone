					...
					<section className="w-full h-[600px] relative overflow-hidden bg-[#54514c]">
						<div className="w-full h-full fcc  absolute  z-50  m-auto">
							<div className="w-[98%] 1400:w-[1300px] h-full m-auto ">
								...
								>
									On PlayStation 4, PlayStation 5, Xbox One,
									Xbox Series X|S, Nintendo Switch, and PC via
									EA App and Steam
								</div>
								...
								>
									*Applicable platform account and platform
									subscription (sold separately) may be
									required. Persistent internet connection and
									EA account required. Age restrictions apply.
