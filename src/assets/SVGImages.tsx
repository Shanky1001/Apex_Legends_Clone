...
export const APEX_LEGEND_LOGO = ({ className }: svgImage) => {
	return (
		<svg
		...
		>
			...
			<g id="Layer_2" data-name="Layer 2">
				<g id="Layer_1-2" data-name="Layer 1">
					...
					<path
						className="cls-1"
						d="M42.69,29.79h-.2v-.11H43v.11h-.2v.74h-.11Z"
					/>
					<path
						className="cls-1"
						d="M43.51,30.53v-.46l-.09.28h-.09l-.08-.28v.46h-.12v-.85h.11l.13.43.14-.43h.11v.85Z"
					/>
				</g>
			</g>
		</svg>
...
export const US_FLag = ({className}:svgImage) => {
	return (
		<svg width="1235" height="650" viewBox="0 0 7410 3900" className={className}>
